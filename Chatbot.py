...
def main():
    ...
    if choice == "Home":
        ...
        if not os.path.exists('That_log.csv'):
    ...
    # Conversation History Menu
        ...
        st.write("""
        The dataset used in this project is a collection of labelled intents and entities. The - Intents: The intent of the user input (e.g. "greeting", "budget", "about")
        - Entities: The entities extracted from user input (e.g. "Hi", "How do I create a budg - Text: The user input text.
        """)
